...
- [ ]Explain the differences between:
    ...
    - [ ] Function scope
    - [ ] Global scope
- [ ] Understand how functions are first-class-objects in JS
...
Today, we will work on functions that will help us accomplish some tasks related to rendering / displaying data in our web browsers. 
...
-  Demo arrow functions pt2: 
    - Create an arrow function that takes `discount` and `book` as parameters. Return the book price divided by the discount. Given `inventory[0]` and 2, the return should be 5.00
- Demo Scope: 
    - Create a variable in global scope and set it to a book's title. 
...
// To run / call / invoke (all the same thing), write the function name and add a pair of `()`
sayHi()

// This function `console.log`s the string of 'hello' but returns undefined because it does not have the return keyword.
